            ...
            if (this.wires[i].wasClicked()) {
              ...
              if(wireClick == 2){
                ...
                node = this.add.circle((this.input.mousePointer.y-this.wireLines[i].geom.y1)/((this.wireLines[i].geom.y1-this.wireLines[i].geom.y2)/(this.wireLines[i].geom.x1-this.wireLines[i].geom.x2))+this.wireLines[i].geom.x1,this.input.mousePointer.y, deviceWidth * 0.005 * scaleCount, 0xffffff);
                  ...
                  node2 = this.add.circle((this.input.mousePointer.y-this.wireLines[i].geom.y1)/((this.wireLines[i].geom.y1-this.wireLines[i].geom.y2)/(this.wireLines[i].geom.x1-this.wireLines[i].geom.x2))+this.wireLines[i].geom.x1,this.input.mousePointer.y, deviceWidth * 0.005 * scaleCount, wireColors[wireColors.length-1]);
                    ...
                    node2 = this.add.circle((this.input.mousePointer.y-this.wireLines[i].geom.y1)/((this.wireLines[i].geom.y1-this.wireLines[i].geom.y2)/(this.wireLines[i].geom.x1-this.wireLines[i].geom.x2))+this.wireLines[i].geom.x1,this.input.mousePointer.y, deviceWidth * 0.005 * scaleCount, 0xED4040);
                  }
                }else{
              ...
              if(wireColors.length > 0){
                  node2 = this.add.circle(this.input.mousePointer.x,this.wireLines[i].geom.y1,deviceWidth * 0.005 * scaleCount, wireColors[wireColors.length-1]);
                    ...
                    node2 = this.add.circle(this.input.mousePointer.x,this.wireLines[i].geom.y1,deviceWidth * 0.005 * scaleCount, 0xED4040);
                }
            }
...
obj2.setLineWidth(deviceWidth*0.002*scaleCount);
                ...
                var obj3 = this.add.rectangle((obj.geom.x1 + obj.geom.x2) / 2, (obj.geom.y1 + obj.geom.y2) / 2, lineWidth, (Math.sqrt(Math.pow(Math.abs(obj.geom.x1 - obj.geom.x2), 2) + Math.pow(Math.abs(obj.geom.y1-obj.geom.y2), 2))), wireColors[wireColors.length - 1]);
                                obj3.setAngle(-(Math.atan(Math.abs(obj.geom.x1-obj.geom.x2) / Math.abs(obj.geom.y1-obj.geom.y2))) * (180 / Math.PI));
                var obj4 = this.add.rectangle((obj2.geom.x1 + obj2.geom.x2) / 2, (obj2.geom.y1 + obj2.geom.y2) / 2, lineWidth, (Math.sqrt(Math.pow(Math.abs(obj2.geom.x1 - obj2.geom.x2), 2) + Math.pow(Math.abs(obj2.geom.y1-obj2.geom.y2), 2))), wireColors[wireColors.length - 1]);
        ...
        for (var i = 0; i < this.objects.length; i++) {
            ...
            for (var v = 0; v < this.nodes.length; v++) {
              if(nodeLinks[v*3] >= 0){
                if (nodeLinks[(v * 3)+1] == i) {
                    this.nodes[v].setX(this.objects[i].x + (wiringXPoints["x" + this.objectIDs[i]][nodeLinks[(v * 3) + 2]] * this.objects[i].width));
                    this.nodes[v].setY(this.objects[i].y + (wiringYPoints["y" + this.objectIDs[i]][nodeLinks[(v * 3) + 2]] * this.objects[i].height));
                }
            }
            if(nodeLinks[v*3] == -3){
          ...
          for(var v = 0; v < this.wireLines.length; v++){
            if(nodeLinks[v*6] >= 0){
            if(nodeLinks[(v*6)+1] == i){
              this.wireLines[nodeLinks[v*6]].setTo(this.nodes[v].x,this.nodes[v].y,this.wireLines[nodeLinks[v*6]].geom.x2,this.wireLines[nodeLinks[v*6]].geom.y2);
            }
            }
            if(nodeLinks[(v*6)+3]>= 0){
     if(nodeLinks[(v*6)+4] == i){
              this.wireLines[nodeLinks[(v*6)+3]].setTo(this.wireLines[nodeLinks[(v*6)+3]].geom.x1,this.wireLines[nodeLinks[(v*6)+3]].geom.y1,this.nodes[v+1].x,this.nodes[v+1].y);
            }
            }
            if(nodeLinks[(v*3)] == -3){
             this.wireLines[nodeLinks[(v*3)+2]].setTo(this.wireLines[nodeLinks[(v*3)+1]].geom.x1,this.wireLines[nodeLinks[(v*3)+1]].geom.y1,this.nodes[v].x,this.nodes[v].y);
            } 
            if(nodeLinks[(v*3)] == -2){
             this.wireLines[nodeLinks[(v*3)+2]].setTo(this.nodes[v].x,this.nodes[v].y,this.wireLines[nodeLinks[(v*3)+1]].geom.x2,this.wireLines[nodeLinks[(v*3)+1]].geom.y2);
            }
            if(v == this.wireLines.length - 1){
              if(nodeLinks[((v+1)*3)] == -2){
             this.wireLines[nodeLinks[((v+1)*3)+2]].setTo(this.nodes[v+1].x,this.nodes[v+1].y,this.wireLines[nodeLinks[((v+1)*3)+1]].geom.x2,this.wireLines[nodeLinks[((v+1)*3)+1]].geom.y2);
            }
            }
            ...
            if(this.wireLines[v].geom.x1 == this.wireLines[v].geom.y1){
              this.wires[v].setAngle(180);
            }
                  ...
                  if(this.esc.wasPressed()){
                    ...
                    if (down == true) {
                        if (this.input.mousePointer.x >= (this.objects[i].x + (wiringXPoints["x" + this.objectIDs[i]][v] * this.objects[i].width)) - deviceWidth * 0.01 && this.input.mousePointer.x <= (this.objects[i].x + (wiringXPoints["x" + this.objectIDs[i]][v] * this.objects[i].width)) + deviceWidth * 0.01 && this.input.mousePointer.y <= (this.objects[i].y + (wiringYPoints["y" + this.objectIDs[i]][v] * this.objects[i].height)) + deviceHeight * 0.015 && this.input.mousePointer.y >= (this.objects[i].y + (wiringYPoints["y" + this.objectIDs[i]][v] * this.objects[i].height)) - deviceHeight * 0.015) {
                            activeWire = false;
                            this.activeWire.setVisible(0);
                          var node = this.add.circle(activeWireXY[2],activeWireXY[3],deviceWidth*0.005*scaleCount,0xED4040);
                          this.nodes.push(node);
                           var node2 = this.add.circle(this.objects[i].x + (wiringXPoints["x" + this.objectIDs[i]][v] * this.objects[i].width), this.objects[i].y + (wiringYPoints["y" + this.objectIDs[i]][v] * this.objects[i].height), deviceWidth * 0.005 * scaleCount, 0xED4040);
                            this.nodes.push(node2);
                            nodeLinks.push(this.wireLines.length);
                            nodeLinks.push(i);
                            nodeLinks.push(v);
                          nodeLinks.push(this.wireLines.length);
                            ...
                            var obj = this.add.line(node.x, ndoe.y, node2.x, node2.y, 0xffffff);                        obj.setLineWidth(deviceWidth*0.002*scaleCount);
                            this.wireLines.push(obj);
                          var obj2;
                            if (wireColors.length > 0) {
